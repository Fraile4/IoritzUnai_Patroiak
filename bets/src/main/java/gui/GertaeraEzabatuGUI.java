	...
	private void jbInit(Vector<domain.Event> v) throws Exception {
		...
		jButtonEzabatu.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				ExtendedIteratorEvents eventsOnDate = (ExtendedIteratorEvents) businessLogic.getEvents(event.getEventDate());
				eventsOnDate.goLast();
				while(eventsOnDate.hasPrevious()){
					modelEvents.addElement(eventsOnDate.previous()); 
				}
