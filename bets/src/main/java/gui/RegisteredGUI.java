...
public class RegisteredGUI extends JFrame {
	...
	private JButton jButtonAdapter;
	 ...
	 * @return void
	 */
	private void initialize(Registered u) {
		// this.setSize(271, 295);
		this.setSize(650, 600);
		this.setContentPane(getJContentPane(u));
	 ...
	 */
	private JPanel getJContentPane(Registered u) {
		if (jContentPane == null) {
			...
			jContentPane.add(getBtnAdapter(u));
	...
	private JButton getBtnAdapter(Registered u) {
		if(jButtonAdapter == null) {
			jButtonAdapter = new JButton(ResourceBundle.getBundle("Etiquetas").getString("TableUser") + " " + u.getUsername()  ); 
			jButtonAdapter.setFont(new Font("Tahoma", Font.PLAIN, 16));
